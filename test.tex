...
\starttext
Testing, testing, just some standard Latin script options: língua portuguesa, português \par

\noindenting Here is some Ethiopic (the defined fallback should switch to Amharic without extra coding in this source text): አማርኛ \par
\blank
\noindenting And this is Russian (since cyrillic is already in NotoSans by default, no fallback is defined to handle this): ру́сский язы́к \par
\blank
